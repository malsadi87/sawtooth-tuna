...
DROP TABLE IF EXISTS PalletEvent;
...
DROP TABLE IF EXISTS CatchPackage;
CREATE TABLE CatchPackage (
...
DROP TABLE IF EXISTS SpeciesAndWeight;
CREATE TABLE SpeciesAndWeight (
...
DROP TABLE IF EXISTS CustomLevelPackage;
CREATE TABLE CustomLevelPackage (
    ConsumerPackageId VARCHAR(255) NOT NULL,
    CatchPackageId VARCHAR(255) NOT NULL,
    PackingDate DATETIME NOT NULL,
    Agent INT NOT NULL,
    PRIMARY KEY (ConsumerPackageId),
    FOREIGN KEY (CatchPackageId) REFERENCES CatchPackage(CatchPackageId),
